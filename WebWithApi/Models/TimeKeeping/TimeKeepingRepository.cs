...
namespace ClearstreamWeb.Models {
    ...
    public class TestTimeKeepingRepository : ITimeKeepingRepository {
        ...
        private void initialize() {
            users = JsonConvert.DeserializeObject<List<WacsTimeKeepingUser>>(@"[{ 'id':6,'login':'MESTEKCORP\\io_rbaker','displayName':'Bob','department':'Eng       ','isDepartmentAdmin':false},{ 'id':12,'login':'MESTEKCORP\\io_dsawyer','displayName':'Dave','department':'Eng       ','isDepartmentAdmin':false},{ 'id':9,'login':'MESTEKCORP\\io_edunkel','displayName':'Eddie','department':'Eng       ','isDepartmentAdmin':false},{ 'id':16,'login':'MESTEKCORP\\io_jwilson','displayName':'Jim ','department':'Eng       ','isDepartmentAdmin':true},{ 'id':14,'login':'MESTEKCORP\\io_jwelty','displayName':'John W','department':'Eng       ','isDepartmentAdmin':true},{ 'id':13,'login':'MESTEKCORP\\io_jzlatohlavek','displayName':'John Z','department':'Eng       ','isDepartmentAdmin':false},{ 'id':15,'login':'MESTEKCORP\\io_jsbrown','displayName':'Judy','department':'Eng       ','isDepartmentAdmin':false},{ 'id':5,'login':'MESTEKCORP\\io_lrieck','displayName':'Lee','department':'Eng       ','isDepartmentAdmin':false},{ 'id':11,'login':'MESTEKCORP\\io_mberry','displayName':'Megan','department':'Eng       ','isDepartmentAdmin':false},{ 'id':10,'login':'MESTEKCORP\\io_skapoor','displayName':'Sid','department':'Eng       ','isDepartmentAdmin':false},{ 'id':8,'login':'MESTEKCORP\\io_sfuegen','displayName':'Steve Fuegen','department':'Eng       ','isDepartmentAdmin':false},{ 'id':7,'login':'MESTEKCORP\\io_sfunk','displayName':'Steve Funk','department':'Eng       ','isDepartmentAdmin':false},{ 'id':1,'login':'MESTEKCORP\\io_skerska','displayName':'Steve K','department':'Eng       ','isDepartmentAdmin':true},{ 'id':4,'login':'MESTEKCORP\\io_tcoon','displayName':'Tim','department':'Eng       ','isDepartmentAdmin':false}]");
